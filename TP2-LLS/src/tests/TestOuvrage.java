...
public class TestOuvrage {
    ...
    public void testOuvrages() {
        ...
        Ouvrage livreA = new OuvragePapier("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", john);
        ...
        Ouvrage livre2 = new OuvrageAudio("Tout va bien", albertine, Ouvrage.Format.AUDIO, LocalDate.now(), -10, EFormat.NUMERIQUE);
        System.out.println(livre2);

        livre2 = new OuvragePapier("Tout va bien", albertine, Ouvrage.Format.PAPIER, LocalDate.now(), 20);
        System.out.println(livre2);

        System.out.println("\n-----Tests des méthodes acheter et vendre-----------");

        Ouvrage livre3 = new OuvragePapier("Musique du hasard", new Auteur("Paul", "Auster", "Etats-Unis"), Ouvrage.Format.PAPIER, LocalDate.now(), 5);
        ...
        Ouvrage livre4 = new OuvragePapier("Test", new Auteur("A", "B", "Etats-Unis"), Ouvrage.Format.PAPIER, LocalDate.now(), 5);

        System.out.println("\n-----Tests de la  méthode equals()-----------");
        //Deux ouvrages égaux
        Ouvrage livre5 = new OuvragePapier("Test", new Auteur("A", "B", "Etats-Unis"), Ouvrage.Format.PAPIER, null, 5);
        Ouvrage livre6 = new OuvragePapier("Test", new Auteur("A", "B", "Etats-Unis"), Ouvrage.Format.PAPIER, LocalDate.now(), 10);
        //Un qui ne l'est pas
        Ouvrage livre7 = new OuvragePapier("Test", new Auteur("Z", "B", "Etats-Unis"), Ouvrage.Format.PAPIER, LocalDate.now(), 5);
